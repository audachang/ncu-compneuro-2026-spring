...
首次啟動會看到歡迎畫面，並出現互動式登入選單。使用 **↑↓ 方向鍵** 選擇、**Enter** 確認：

![Claude Code 歡迎畫面與登入方式選單](week-09-intro_to_vibe_coding_and_claude_code/images/2026-04-23_04-40-55.jpg)
...
選擇選項 1 後，CLI 會自動開啟預設瀏覽器，導向 `https://claude.ai/oauth/authorize`。瀏覽器會顯示如下的授權同意頁面：

![OAuth 授權頁面](week-09-intro_to_vibe_coding_and_claude_code/images/2026-04-23_04-41-13.jpg)

頁面列出 Claude Code 將使用的權限項目：
...
頁面底部會顯示目前登入的帳號（如 `icnaicoding@gmail.com`）。若需切換帳號，點選「Switch account」。

![OAuth 授權頁面（確認帳號）](week-09-intro_to_vibe_coding_and_claude_code/images/2026-04-23_04-41-32.jpg)

確認帳號無誤後，點選白色的 **Authorize** 按鈕。
...
| npm 找不到 | 至 nodejs.org 安裝 Node.js（≥ 18），重新開啟 PowerShell |
