"""Compile week07 individual feedback MD files to PDFs named by Chinese student name.
...
The Windows path is the default; the Linux path runs automatically when xelatex.exe
is not available (e.g., in a sandbox or CI).
"""
import os
import shutil
import subprocess
