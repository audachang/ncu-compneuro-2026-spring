...
def slide_cache_data_core(prs, page, total):
    ...
    add_demo_ref(s, "demo/01_cache_data/cache_demo.py")
    add_footer(s, page, total)
    return s
...
def slide_cache_key(prs, page, total):
    ...
    add_callout(s,
        ...
        Inches(0.9), Inches(5.85), Inches(11.5), Inches(0.95),
        size=17, color=ACCENT_PRIMARY)
...
def slide_cache_params(prs, page, total):
    ...
    add_code(s, code,
             Inches(1.0), Inches(5.80), Inches(11.3), Inches(0.95),
             size=13)
...
def slide_descriptive_stats(prs, page, total):
    ...
    add_callout(s,
        ...
        Inches(0.9), Inches(6.15), Inches(11.5), Inches(0.7),
        size=18, color=ACCENT_PRIMARY)
...
def slide_diagnose_table(prs, page, total):
    ...
    add_table(s, ["觀察到的現象", "可能的問題"], rows,
              Inches(1.4), Inches(2.0), Inches(10.5), Inches(4.7),
