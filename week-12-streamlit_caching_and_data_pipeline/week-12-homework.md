...
**檔案**：`demo/data/messy_stroop_homework.csv` (n ≈ 240 trials，含若干重複 row)

如果遺失，可在 `demo/data/` 執行 `python generate_messy_stroop_homework.py`
重新生成（`seed=2026`）。
...
- **生成器原始碼公開**（`demo/data/generate_messy_stroop_homework.py`）— 等於
