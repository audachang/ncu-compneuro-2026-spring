---
title: "A few random notes from Claude coding"
...
**Source:** [X.com Post](https://x.com/karpathy/status/2015883857489522876)
...
## IDEs, Agent Swarms, and Fallability
...
2. I can approach code that I couldn't work on before because of knowledge/skill issue. 

So certainly it's speedup, but it's possibly a lot more an expansion.
...
I have seen the opposite sentiment from other people too; LLM coding will split up engineers based on those who primarily liked coding and those who primarily liked building.
